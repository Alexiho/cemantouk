...
def fobjectif2():
    ...
    # ou on lui demande un domaine précis au hasard
    domaines = ["nature", "technologie", "sentiments", "objets du quotidien", "médias", "sport"]
    domaine_choisi = random.choice(domaines)
    
    question = f"Donne-moi un seul nom commun en français dans le domaine : {domaine_choisi}. Juste le mot, sans article."
